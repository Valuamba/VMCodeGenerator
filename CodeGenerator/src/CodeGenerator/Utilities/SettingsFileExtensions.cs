...
namespace CodeGenerator.Utilities
{
    public static class SettingsFileExtensions
    {
        ...
        public static T GetValueOrNew<T>(this JsonSettingsFile file, string path) where T : new()
        {
        ...
        public static IReadOnlyList<T> GetValueListOrEmpty<T>(this JsonSettingsFile file, string path)
        {
        ...
        public static T GetValueOrDefault<T>(this JsonSettingsFile file, string path, T defaultValue = default(T))
        {
